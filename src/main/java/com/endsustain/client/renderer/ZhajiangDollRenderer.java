...
public class ZhajiangDollRenderer extends GeoItemRenderer<ZhajiangDollItem> {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext displayContext,
        ...
        try {
            ...
            ItemStack renderedStack = stack == null ? ItemStack.EMPTY : stack;
            super.renderByItem(renderedStack, displayContext, poseStack, bufferSource, packedLight, packedOverlay);
        } finally {
            poseStack.popPose();
        }
    }
